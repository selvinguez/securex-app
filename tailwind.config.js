...
const securexcolors = require('./src/assets/colors/color-palette.json');
...
const customPalettes = {
    brand: generatePalette(securexcolors.primary[500])
};
...
const themes = {
    ...
    'default': {
        primary  : {
            ...securexcolors.primary,
            DEFAULT: securexcolors.primary[600]
        },
        accent   : {
            ...securexcolors.secundary,
            DEFAULT: securexcolors.secundary[800]
        },
        warn     : {
            ...securexcolors.warning,
            DEFAULT: securexcolors.warning[600]
        },
        'on-warn': {
            500: securexcolors.warning[50]
        }
    },
...
const config = {
    ...
    theme      : {
        ...
        extend  : {
            ...
            colors                  : {
                gray: securexcolors.neutral
            },
            gradientColorStops: {
                'blue-pink': ['#4169E1', '#FF69B4'],
                'green-purple': ['#00FF00', '#800080'],
                // Agrega más degradados personalizados según tus necesidades
            },
            flex                    : {
                '0': '0 0 auto'
            },
